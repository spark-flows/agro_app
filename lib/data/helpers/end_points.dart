class EndPoints {
  ...
  static String createProductApi = 'api/product/create';
  ...
  static String changeOrderStatusApi = 'api/order/changestatus';
  ...
  static String getOneUserApi = 'api/users/getone';
