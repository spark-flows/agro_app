...
class GetAllOrderData {
    ...
    factory GetAllOrderData.fromJson(Map<String, dynamic> json) => GetAllOrderData(
        docs: json["docs"] == null ? [] : List<GetAllOrderDoc>.from(json["docs"]!.map((x) => GetAllOrderDoc.fromJson(x))),
...
class GetAllOrderRid {
    ...
    factory GetAllOrderRid.fromJson(Map<String, dynamic> json) => GetAllOrderRid(
    );
...
class GetAllOrderItem {
    ...
    factory GetAllOrderItem.fromJson(Map<String, dynamic> json) => GetAllOrderItem(
        id: json["_id"],
