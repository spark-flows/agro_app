...
class LedgerPdfPreviewPage extends StatelessWidget {
  const LedgerPdfPreviewPage({super.key});

  @override
  Widget build(BuildContext context) {
    final List<dynamic> args = Get.arguments as List<dynamic>;
    final Uint8List pdfBytes = args[0] as Uint8List;
    final String fileName = args[1] as String;
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Statement Preview', style: Styles.txtBlackColorW70020),
        actions: [
          IconButton(
            icon: const Icon(
